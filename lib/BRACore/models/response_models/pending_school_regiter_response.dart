...
//
//     final pendingSchoolRegisterResponse = pendingSchoolRegisterResponseFromJson(jsonString);

import 'dart:convert';

import 'package:qr_scaner_manrique/BRACore/models/response_models/lector_response.dart';

List<PendingSchoolRegisterResponse> pendingSchoolRegisterResponseFromJson(String str) => List<PendingSchoolRegisterResponse>.from(json.decode(str).map((x) => PendingSchoolRegisterResponse.fromJson(x)));

String pendingSchoolRegisterResponseToJson(List<PendingSchoolRegisterResponse> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class PendingSchoolRegisterResponse {
    int? idHijo;
    int? idHijoResidente;
