...
import 'package:qr_scaner_manrique/pages/parking/historic_parking/historic_parkin_controller.dart';
...
class ParkingDateRangeHistoric extends StatelessWidget {
  ParkingDateRangeHistoric();
  @override
  Widget build(BuildContext context) {
    final theme = Theme.of(context);
    final stringLocations = AppLocalizationsGenerator.appLocalizations(context: context);
    return GetBuilder<HistoricParkinController>(
        builder: (_) {
          return Container(
