...
class SalidaPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: GetBuilder<SalidaController>(
        builder: (_) {
          return Scaffold(
            body: Stack(
              children: [
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      const Text('Lista de padres', style: TextStyle(
                        fontSize: 17
                      ),),
                      Obx(() {
                          ...
                          return ListTile(
                            ...
                            title: Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Text(_.parentList[i].padre ?? '', style: TextStyle(color: Colors.white),),
                                  Row(
                                    crossAxisAlignment: CrossAxisAlignment.end,
                                    children: [
                                      Text(_.parentList[i].hijos != null ? _.parentList[i].hijos!.length.toString() : '0',
                                      style: TextStyle(fontSize: 23, color: Colors.white, fontWeight: FontWeight.bold),),
                                      const Image(image: AssetImage('assets/images/student.png'),
                                      width: 35, height: 35,),
                                    ],
                                  )
                                ],
